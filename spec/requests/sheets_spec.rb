  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Sheet" do
        expect {
          post sheets_url, params: { sheet: valid_attributes }
        }.to change(Sheet, :count).by(1)
      end

      it "redirects to the created sheet" do
        post sheets_url, params: { sheet: valid_attributes }
        expect(response).to redirect_to(sheet_url(Sheet.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new Sheet" do
        expect {
          post sheets_url, params: { sheet: invalid_attributes }
        }.to change(Sheet, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested sheet" do
        sheet = Sheet.create! valid_attributes
        patch sheet_url(sheet), params: { sheet: new_attributes }
        sheet.reload
      ...
      it "redirects to the sheet" do
        ...
        patch sheet_url(sheet), params: { sheet: new_attributes }
        sheet.reload
        expect(response).to redirect_to(sheet_url(sheet))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        sheet = Sheet.create! valid_attributes
        patch sheet_url(sheet), params: { sheet: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
